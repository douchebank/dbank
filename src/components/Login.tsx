  ...
  return (
    ...
    <p className="text-center font-bold text-xl">Select Account</p>
      ...
      <div className='flex flex-col my-12 gap-4'>
        ...
        <button className="p-2 px-4 w-full rounded-lg bg-black text-white shadow-lg">Login</button>
      </div>
      <p onClick={onClose} className=" w-full text-gray-700 pt-2 border-t border-dashed border-gray-500">Already have an account ?</p>
  </div>
  )
}
